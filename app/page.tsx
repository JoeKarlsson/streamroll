...
const HOLIDAYS: Preset[] = [
  ...
  { name: "PrideFlix",    emoji: "🌈", style: "futuristic", tagline: "Stream with pride",             desc: "Pride",           customNotes: "full rainbow ROYGBIV spectrum light beams blazing across the frame, holographic prism effect splitting light into all colors, joyful celebration energy, vivid saturated rainbow gradient, pride parade radiance" },
